                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" action="drejtimet.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="orari" name="emri" required="required" placeholder="Orari">
                                </div>
                            </div>
                            <div class="form-group">
            ...
            <div id="side" class="col-md-6">
                <form class="form-horizontal" role="form" action="fakultetet.php" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="idGrupit" name="id1" required="required" placeholder="Id e grupit" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="emriGrupit" class="col-sm-3 control-label">Emri</label>
